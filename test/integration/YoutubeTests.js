...
describe('YoutubeApi', function () {
    ...
    it('should work with youtube playlist link', function (done) {
        var postdata = {
    ...
    it('should load youtube song with direct link', function (done) {
        var postdata = {
            youtubeurl: 'https://www.youtube.com/watch?v=he2a4xK8ctk'
        };
        api.post('/youtube').send(postdata).expect(200).end(function (err, res) {
    ...
    it('should upload youtube song again even if already uploaded', function (done) {
        var postdata = {
            youtubeurl: 'https://www.youtube.com/watch?v=he2a4xK8ctk'
        };
        api.post('/youtube').send(postdata).expect(200).end(function (err, res) {
    ...
    it('should load youtube song with video link and additional data', function (done) {
        var postdata = {
    ...
    it('should send 500 with not youtube url', function (done) {
        var postdata = {
    ...
    it('should send 400 if youtube url is missing in post request', function (done) {
        var postdata = {};
    ...
    it('should send 400 if youtube url is missing in post request but with other set fields', function (done) {
        var postdata = {
            data: 'testdata'
        };
        api.post('/youtube').send(postdata).expect(400).end(function (err, res) {
    ...
    it('should send 400 if post data is missing', function (done) {
